      ...
      children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.start,
         children: [Column(crossAxisAlignment: CrossAxisAlignment.start,
           children: [
             PropertyDetails(title: 'Bedrooms', number: '3',icon:Icon(Icons.bed_outlined,size: 18,),),
          SizedBox(height: 12,),PropertyDetails(title: 'Build', number:'2020'), 
           ],
         ),SizedBox(width: 71,),
        Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            PropertyDetails(title: 'Bathub', number: '2',icon: SvgPicture.asset('assets/icons/path.svg'),),
       SizedBox(height: 12,),PropertyDetails(title: 'Parking', number: '1 Indoor'), ],
        ...
        SizedBox(height: 12,),  PropertyDetails(title:'Status', number:'For Rent')],
        )],),
    SizedBox(height: 12,),
