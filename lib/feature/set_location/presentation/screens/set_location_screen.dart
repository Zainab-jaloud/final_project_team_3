...
class SetLocationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(24),side: BorderSide(color:AppColors.unselectedBorderColor ,width: 1)) ),
          ...
          child: Column( crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                      ...
                      Image.asset("assets/images/select_location.png"),
                       ...
                       Text('Choose your location to fint property arround you.',style:AppTextStyle.resendPromptStyle,),
