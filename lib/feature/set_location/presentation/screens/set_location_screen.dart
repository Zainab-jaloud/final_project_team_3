...
class SetLocationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(24),side: BorderSide(color:AppColors.inputBorderColor ,width: 1)) ),
          ...
          child: Column( crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                      ...
                      Image.asset("assets/images/select_location.png"),
                       ...
                       Text('Hi, Nice to meet you !',style: AppTextStyle.optionValueStyle.copyWith(fontSize: 20.sp),),
                       Text('Choose your location to fint property arround you.',style:AppTextStyle.optionLabelStyle.copyWith(fontSize: 14.sp),),
